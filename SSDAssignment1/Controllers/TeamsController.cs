// I, Mesut Baltaci, student number 000800221, certify that this material is my
...
/// Purpose :    This controller determines what response to send back to a user when a user makes a browser request
/// </summary> 
using System;
